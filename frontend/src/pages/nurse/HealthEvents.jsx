...
const HealthEvents = () => {
  ...
  const emergencyEvents = applyFilters(events).filter((event) => {
    const isEmergency =
      event.eventType?.toLowerCase().includes("cấp cứu") ||
    ...
    return (
      ...
      (event.eventType?.toLowerCase().includes(searchEmergency.toLowerCase()) ||
        ...
        event.studentName
          ?.toLowerCase()
          .includes(searchEmergency.toLowerCase()) ||
      ...
      const data = {
        ...
        medicalEventSupplys:
          validSupplies.length > 0
            ...
            : [], // Gửi mảng rỗng thay vì mảng có phần tử với id = 0
        nurseId: parseInt(user.id),
        studentNumber: formAdd.studentNumber.trim() || "", // Luôn gửi studentNumber, có thể rỗng
      };
  ...
  //     console.log("Chi tiết sự kiện:", res);
  ...
  const loadMedicalEventDetailModal = async (eventId) => {
    try {
      console.log("Gọi API với ID:", eventId);
      setDetailLoading(true);
      const res = await getMedicalEventDetail(eventId);
      console.log("Kết quả chi tiết:", res);
      setModalEventDetail(res || {});
      setModalEvent(true);
    } catch (error) {
      showNotification("Lỗi khi tải chi tiết sự kiện!", "error");
                ...
                >
                  <div className="medicine-info">
                    ...
                    <span title={event.description}>
                      {(event.description || "N/A").substring(0, 50)}...
                    </span>
                  </div>
                </td>
                <td
  ...
  //             setEvents(Array.isArray(res) ? res : []); // Đảm bảo luôn là array
  //             setEvents(res || []);
    ...
    >
      ...
      >
        ...
        <Modal.Body className="modal-body-custom">
          ...
          {!detailLoading && !modalEventDetail.eventType && (
            ...
            <div className="detail-content">
              <div className="detail-grid">
                <div className="detail-section">
                  <h6>
                    <FaCalendarAlt /> Thông tin sự kiện
                  </h6>
                ...
                <div className="detail-section">
                  <h6>
                    <FaUser /> Thông tin liên quan
                  </h6>
                  <div className="detail-row">
                    <span className="label">Học sinh:</span>
                    <span className="value">
                      {modalEventDetail.studentName || "Không có"}
                    </span>
                  </div>
                  <div className="detail-row">
                ...
                <div className="detail-section full-width">
                  <h6>
                    <FaClipboardList /> Mô tả chi tiết
                  </h6>
                  <div className="detail-row">
                ...
                {modalEventDetail.medicalEventSupplys &&
                  modalEventDetail.medicalEventSupplys.length > 0 && (
                    <div className="detail-section full-width">
                      <h6>
                        <FaMedkit /> Vật tư y tế đã sử dụng
                      </h6>
                      <div className="supplies-list">
                        {modalEventDetail.medicalEventSupplys.map(
                          (supply, index) => (
      ...
      <Modal
        ...
        size="xl"
        className="medicine-detail-modal add-event-modal"
      >
        <Modal.Header closeButton className="modal-header-custom">
          <Modal.Title>
                  ...
                  <div className="event-form-section">
                    ...
                    <div className="form-group-enhanced">
                      ...
                      <Form.Group className="mb-4" controlId="studentNumber">
                        ...
                        <div className="form-help">
                          <strong>⚠️ Lưu ý:</strong> Chỉ nhập mã học sinh đã tồn
                          tại trong hệ thống. Để trống để tạo sự kiện chung.
                        </div>
                      </Form.Group>
