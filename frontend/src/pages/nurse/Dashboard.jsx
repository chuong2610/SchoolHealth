...
const ClockSvg = () => (
  ...
  >
    ...
    <g>
      ...
      <path
        fill="url(#clockSimpleGradient)"
        d="M16,2.5C8.544,2.5,2.5,8.544,2.5,16S8.544,29.5,16,29.5S29.5,23.456,29.5,16S23.456,2.5,16,2.5z M16,27.5C9.649,27.5,4.5,22.351,4.5,16S9.649,4.5,16,4.5S27.5,9.649,27.5,16S22.351,27.5,16,27.5z"
      />
      <path
        fill="#231F20"
        d="M15,24h2v1h-2V24z M17,8h-2V7h2V8z M25,15v2h-1v-2H25z M7,15h1v2H7V15z M16,16h4v1h-5v-7h1V16z"
      />
    </g>
  </svg>
);
...
const HealthSvg = () => (
  ...
  >
    ...
    <g>
      ...
      <polyline
        fill="#ffffff"
        points="60.21 43.33 61.09 112.15 89.47 88.32 117.86 111.4 117.86 43.05"
      />
      <path
        fill="url(#packageGradient3)"
        d="M120.84,123.32,88.41,90.89,56.08,122.06V41.17a4,4,0,1,1,8,0v62.06L88.51,79.67,112.84,104V40.89a4,4,0,0,1,8,0Z"
      />
      <rect fill="#efa536" height="9.06" width="221" x="3.87" y="176.54" />
      <path
        fill="#ffffff"
        d="M19.82,96.15a3,3,0,0,1-3-3V82a3,3,0,0,1,6,0V93.15A3,3,0,0,1,19.82,96.15Z"
      />
      <path
        fill="#ffffff"
        d="M19.82,75.57a3,3,0,0,1-3-3V66.52a3,3,0,0,1,6,0v6.05A3,3,0,0,1,19.82,75.57Z"
      />
      <circle fill="#ffffff" cx="19.78" cy="105.71" r="3.54" />
      <path
        fill="url(#packageGradient3)"
        d="M215,193.68H14a14,14,0,0,1-14-14v-129a14,14,0,0,1,14-14H215a14,14,0,0,1,14,14V84.83a4,4,0,1,1-8,0V50.68a6,6,0,0,0-6-6H14a6,6,0,0,0-6,6v129a6,6,0,0,0,6,6H215a6,6,0,0,0,6-6V139.83a4,4,0,0,1,8,0v39.86A14,14,0,0,1,215,193.68Z"
      />
      <ellipse fill="#908152" cx="171.89" cy="59.04" rx="43.58" ry="43.66" />
      <circle fill="#ffffff" cx="172.24" cy="48.12" r="43.66" />
      <path
        fill="#d9f0ff"
        d="M216.6,47.78a43.66,43.66,0,1,1-85.06-13.86c3.58,20.17,22.14,38.32,41.4,38.32s36.84-14.6,41.4-38.32A43.42,43.42,0,0,1,216.6,47.78Z"
      />
      <path
        fill="#d9f0ff"
        d="M216.23,47.11a43.66,43.66,0,1,1-87.31,0,44.17,44.17,0,0,1,.37-5.69,43.66,43.66,0,0,0,86.57,0A44.2,44.2,0,0,1,216.23,47.11Z"
      />
      <path
        fill="url(#packageGradient3)"
        d="M172,95.31a47.66,47.66,0,1,1,47.66-47.66A47.71,47.71,0,0,1,172,95.31ZM172,8a39.66,39.66,0,1,0,39.66,39.66A39.7,39.7,0,0,0,172,8Z"
      />
      <path
        fill="url(#packageGradient3)"
        d="M161.12,47.68a3.22,3.22,0,0,1,.59-2,1.86,1.86,0,0,1,1.56-.8H169V39a2,2,0,0,1,.86-1.59,3.16,3.16,0,0,1,2-.7,3,3,0,0,1,2,.7,2.06,2.06,0,0,1,.81,1.59v5.91h5.72a2,2,0,0,1,1.56.82,2.92,2.92,0,0,1,.7,2,2.86,2.86,0,0,1-.67,2,2.05,2.05,0,0,1-1.59.77h-5.72v6A2,2,0,0,1,174,58a3.27,3.27,0,0,1-2.08.61,3.41,3.41,0,0,1-2.08-.61,1.91,1.91,0,0,1-.84-1.62v-6h-5.77a1.9,1.9,0,0,1-1.56-.74A3.08,3.08,0,0,1,161.12,47.68Z"
      />
      <path
        fill="url(#packageGradient3)"
        d="M224.49,125.64a4,4,0,0,1-4-4v-7.31a4,4,0,0,1,8,0v7.31A4,4,0,0,1,224.49,125.64Z"
      />
      <path
        fill="url(#packageGradient3)"
        d="M224.49,105.64a4,4,0,0,1-4-4v-.31a4,4,0,0,1,8,0v.31A4,4,0,0,1,224.49,105.64Z"
      />
    </g>
  </svg>
);
...
const Dashboard = () => {
  ...
  const medicineColumns = [
    ...
    },
    {
      ...
      width: 70,
      render: (className) => (
        <Badge count={className} className="nurse-badge" />
      ),
    },
    {
      title: "Thuốc",
            ...
            <motion.div variants={itemVariants}>
              <Card className="nurse-stat-card appointments-today">
                <div className="nurse-stat-content">
                  ...
                  <div className="nurse-stat-info">
                    <div className="nurse-stat-label">Sự kiện hôm nay</div>
              ...
              <Card className="nurse-stat-card health-declarations">
                <div className="nurse-stat-content">
                  ...
                  <div className="nurse-stat-info">
                    ...
                    <div className="nurse-stat-number">
                      {newHealthDeclarations}
                    </div>
                  </div>
                </div>
              </Card>
