...
const NotificationsManagement = () => {
  ...
  return (
    <div className="admin-notifications-container">
      ...
      {/* Notifications Table */}
      <div className="admin-notifications-table-container" style={{
        ...
        {notifications.length === 0 ? (
          ...
          <div style={{ overflowX: "auto" }}>
            <Table className="admin-notifications-table" responsive hover style={{
              marginBottom: 0,
              minWidth: "800px"
            }}>
              <thead style={{
                ...
                {notifications?.map((notification, idx) => (
                  <tr key={idx} style={{
                    ...
                    <td style={{ padding: "1rem" }}>
                      <div className="admin-table-title" style={{
                        maxWidth: "180px",
                        whiteSpace: "nowrap",
                        overflow: "hidden",
                        ...
                        {notification.title && notification.title.length > 30
                        ...
                        style={{
                          ...
                          backgroundColor: notification.type === "Vaccination"
                            ...
                            : notification.type === "HealthCheck"
                              ? "#e8f5e8"
                              : "#f3e5f5",
                          color: notification.type === "Vaccination"
                            ? "#1976d2"
                            : notification.type === "HealthCheck"
                              ? "#388e3c"
                              : "#7b1fa2"
                    ...
                    <td style={{ padding: "1rem" }}>
                      <div className="admin-table-date" style={{
                        fontSize: "0.9rem",
                        color: "#6b7280",
                        whiteSpace: "nowrap"
                      }}>
                    ...
                    <td className="admin-action-cell" style={{
                      padding: "1rem",
                      textAlign: "center"
                    }}>
      ...
      >
        ...
        <Modal.Body style={{ padding: "2.5rem", background: "#fafafa" }}>
          ...
          >
            ...
            {/** */}
            {modalAdd.notification.type === "OtherCheck" && (
              <fieldset
                className="admin-form-section"
                style={{
                  border: "2px solid #e5e7eb",
