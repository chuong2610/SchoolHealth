...
const MedicineInventory = () => {
  ...
  const fetchInventory = async () => {
    try {
      const respond = await axiosInstance.get(
        `/MedicalSupply?pageNumber=${currentPage}&pageSize=10${
  ...
  // Lấy dữ liệu cho biểu đồ thuốc (tên và số lượng)
  ...
  const medicineChartData = getMedicineChartData();
      ...
      >
        ...
        <motion.div variants={itemVariants} className="admin-medicine-stats">
          <div className="admin-medicine-stat-card">
            ...
            <div className="admin-medicine-stat-value">
              {inventoryStats.totalMedications}
            </div>
